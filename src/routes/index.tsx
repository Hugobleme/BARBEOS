      ...
      <section className="relative overflow-hidden">
        ...
        <div className="mx-auto grid max-w-6xl gap-10 px-4 py-16 md:grid-cols-2 md:items-center md:px-6 md:py-24">
          ...
          <div className="relative">
            <div className="aspect-[4/5] overflow-hidden rounded-3xl border border-border shadow-xl">
              <img src={heroImage} alt="Interior moderno da BarberOS" width={1024} height={1280} className="h-full w-full object-cover" />
            </div>
            <div className="absolute bottom-4 left-4 right-4 rounded-2xl border border-border bg-background/85 p-4 backdrop-blur md:left-6 md:right-auto md:max-w-[260px]">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="font-display font-semibold leading-tight">BarberOS</div>
                  <div className="flex items-center gap-1 text-xs text-muted-foreground"><MapPin className="h-3 w-3" /> Rua Augusta, 1500</div>
                </div>
              </div>
            </div>
          </div>
