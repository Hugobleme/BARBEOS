    ...
    <div className="flex h-[calc(100vh-4rem)] flex-col bg-background">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-border/40 p-4 sm:p-5 bg-card/40 backdrop-blur-md shrink-0">
        ...
        {canManage && (
          <Button
            onClick={openNew}
            className="bg-accent text-accent-foreground w-full sm:w-auto h-11"
          >
          ...
          {isLoading ? (
            ...
            <div className="flex flex-col items-center justify-center p-12 text-center border border-dashed border-border/40 rounded-xl bg-muted/10 mt-8">
              ...
              <p className="text-sm text-muted-foreground max-w-md mt-1">
                Comece adicionando o primeiro cupom.
              </p>
              {canManage && (
                <Button
                  onClick={openNew}
                  ...
                  >
                    <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-6">
                      <div>
                        <div className="flex items-center gap-2 mb-1">
                          ...
                          {!c.active ? (
                            ...
                            <Badge
                              variant="outline"
                              className="bg-destructive/10 text-destructive border-0 text-[10px]"
                            >
                              Expirado
                            </Badge>
                          ) : isLimit ? (
                            <Badge
                              variant="outline"
                              className="bg-orange-500/10 text-orange-500 border-0 text-[10px]"
                            >
                              Esgotado
                            </Badge>
                          ) : (
                            <Badge
                              variant="outline"
                              className="bg-emerald-500/10 text-emerald-500 border-0 text-[10px]"
                            >
                              Ativo
                            </Badge>
                          )}
                      ...
                      <div className="text-sm text-muted-foreground flex flex-col gap-0.5">
                        ...
                        <span>
                          Usos: {c.used_count || 0} {c.usage_limit ? `/ ${c.usage_limit}` : ""}
                        </span>
                      </div>
                    </div>
    ...
    <Dialog open={open} onOpenChange={(o) => !o && onClose()}>
      <DialogContent className="max-w-md w-[95vw] rounded-xl max-h-[90vh] overflow-y-auto">
        <DialogHeader className="text-left">
          ...
          <DialogDescription>Configure as regras do desconto promocional.</DialogDescription>
        </DialogHeader>
