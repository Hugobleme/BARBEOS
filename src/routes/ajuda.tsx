...
export const Route = createFileRoute("/ajuda")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Tire dúvidas sobre como encontrar barbearias, criar uma conta e usar o BARBEOS.",
      },
    ],
  }),
  component: AjudaPage,
        ...
        <section className="px-4 py-16 md:py-24 max-w-3xl mx-auto">
            ...
            <Accordion type="single" collapsible className="w-full">
              <AccordionItem value="c1" className="border-border/40">
                ...
                <AccordionContent className="text-muted-foreground leading-relaxed">
                  Acesse a página de barbearias e use os filtros disponíveis para encontrar unidades
                  por cidade, bairro ou avaliação, quando essas informações estiverem cadastradas.
                </AccordionContent>
              </AccordionItem>
              <AccordionItem value="c2" className="border-border/40">
                ...
                <AccordionContent className="text-muted-foreground leading-relaxed">
                  Não. Você pode explorar os perfis públicos das barbearias antes de entrar ou criar
                  uma conta.
                </AccordionContent>
              </AccordionItem>
              <AccordionItem value="c3" className="border-border/40">
                ...
                <AccordionContent className="text-muted-foreground leading-relaxed">
                  O perfil pode apresentar informações da unidade, serviços, profissionais e outros
                  dados que a própria barbearia disponibilizar.
                </AccordionContent>
              </AccordionItem>
          ...
          <div className="mb-16">
            ...
            <Accordion type="single" collapsible className="w-full">
              <AccordionItem value="b1" className="border-border/40">
                ...
                <AccordionContent className="text-muted-foreground leading-relaxed">
                  Crie sua conta e acesse o painel. O checklist de primeiros passos ajuda a
                  completar perfil, serviços, profissionais, horários e revisão do perfil público.
                </AccordionContent>
              </AccordionItem>
              <AccordionItem value="b2" className="border-border/40">
                ...
                <AccordionContent className="text-muted-foreground leading-relaxed">
                  Sim. Pelo painel administrativo, a barbearia pode organizar os profissionais
                  vinculados à sua operação.
                </AccordionContent>
              </AccordionItem>
              <AccordionItem value="b3" className="border-border/40">
                ...
                <AccordionContent className="text-muted-foreground leading-relaxed">
                  No painel administrativo, acesse a área de serviços para cadastrar e atualizar as
              ...
              <AccordionItem value="b4" className="border-border/40 border-b-0">
                ...
                <AccordionContent className="text-muted-foreground leading-relaxed">
                  Após acessar o painel administrativo, abra “Primeiros passos” para acompanhar o
                  andamento da configuração da unidade.
                </AccordionContent>
              </AccordionItem>
            </Accordion>
          </div>
          ...
          <Card className="p-8 md:p-12 text-center bg-muted/20 border-border/40 rounded-3xl mt-12">
            ...
            <p className="text-muted-foreground mb-8 max-w-lg mx-auto">
              Acesse sua conta ou fale com a equipe responsável pela sua barbearia para obter
              suporte sobre informações específicas.
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Button
                asChild
                size="lg"
                className="w-full sm:w-auto h-12 bg-foreground text-background hover:bg-foreground/90 font-bold uppercase tracking-wider text-xs"
              >
              ...
              <Button
                ...
                variant="outline"
                size="lg"
                className="w-full sm:w-auto h-12 font-bold uppercase tracking-wider text-xs"
              >
