...
export const Route = createFileRoute("/para-barbearias")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Organize sua agenda, equipe, serviços e presença online com o BARBEOS.",
      },
      ...
      <div className="bg-background min-h-screen text-foreground selection:bg-accent/30 selection:text-accent-foreground">
        ...
        <section className="relative px-4 py-20 md:py-32 flex flex-col items-center text-center overflow-hidden">
          ...
          <div className="relative z-10 max-w-3xl mx-auto space-y-6">
            ...
            <p className="text-muted-foreground text-base md:text-lg max-w-2xl mx-auto leading-relaxed">
              Transforme sua gestão, elimine horários vazios e entregue uma experiência de
              agendamento premium que fideliza clientes 24h por dia.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
              <Button
                asChild
                size="lg"
                className="w-full sm:w-auto h-14 px-8 bg-accent text-accent-foreground hover:bg-foreground hover:text-background text-sm font-bold uppercase tracking-wider transition-all"
              >
              ...
              <Button
                ...
                variant="outline"
                size="lg"
                className="w-full sm:w-auto h-14 px-8 text-sm font-bold uppercase tracking-wider"
              >
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-serif font-bold">
                Menos improviso. Mais tempo para atender bem.
              </h2>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <Card className="p-8 bg-card border-border/40 hover:border-accent/30 transition-colors">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Automatize 100% da sua agenda e liberte-se do WhatsApp. Seus clientes agendam em
              ...
              <Card className="p-8 bg-card border-border/40 hover:border-accent/30 transition-colors">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Acompanhe comissões, desempenho da equipe e faturamento em tempo real num
                  dashboard construído para o dono.
                </p>
              </Card>
              <Card className="p-8 bg-card border-border/40 hover:border-accent/30 transition-colors">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Não seja apenas mais uma barbearia. Tenha uma página de agendamento exclusiva, que
                  valoriza sua marca e converte visitantes em clientes.
                </p>
              </Card>
            </div>
          </div>
        ...
        <section id="recursos" className="px-4 py-24 scroll-mt-20">
          <div className="max-w-5xl mx-auto text-center space-y-16">
            <h2 className="text-3xl md:text-4xl font-serif font-bold">
              O essencial para gerenciar sua operação
            </h2>
            ...
            <div className="grid sm:grid-cols-2 gap-x-8 gap-y-12 text-left">
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Monitore os agendamentos realizados pelos clientes e tenha uma visão clara do
                    dia a dia da barbearia.
                  </p>
                </div>
              </div>
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Cadastre cortes, barbas e tratamentos com valores, durações e descrições
                    detalhadas.
                  </p>
                </div>
              </div>
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Vincule os membros da sua equipe, defina as especialidades e conecte os serviços
                    que cada um realiza.
                  </p>
                </div>
              </div>
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Uma página dedicada para sua marca onde os clientes podem consultar informações
                    e iniciar novos agendamentos.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="px-4 py-24 bg-muted/20 border-y border-border/40">
          <div className="max-w-4xl mx-auto text-center space-y-16">
            ...
            <div className="grid md:grid-cols-3 gap-8 relative">
              <div
                className="hidden md:block absolute top-6 left-[15%] right-[15%] h-[1px] bg-border border-dashed z-0"
                aria-hidden="true"
              />
              ...
              <div className="relative z-10 flex flex-col items-center">
                ...
                <p className="text-muted-foreground">
                  Entre no BARBEOS usando o cadastro da sua barbearia.
                </p>
              </div>
              ...
              <div className="relative z-10 flex flex-col items-center">
                ...
                <p className="text-muted-foreground">
                  Complete o perfil, cadastre os serviços, a equipe e os horários.
                </p>
              </div>
              ...
              <div className="relative z-10 flex flex-col items-center">
                ...
                <p className="text-muted-foreground">
                  Revise sua página pública e comece a organizar seus atendimentos.
                </p>
              </div>
            </div>
            ...
            <div className="pt-8">
              <Button
                asChild
                size="lg"
                className="h-14 px-10 bg-foreground text-background hover:bg-foreground/90 text-sm font-bold uppercase tracking-wider"
              >
        ...
        <section className="px-4 py-20 bg-background">
          <div className="max-w-3xl mx-auto text-center p-10 md:p-14 border border-border/60 rounded-3xl bg-card shadow-sm">
            <h2 className="text-2xl font-serif font-bold mb-4">
              Saiba exatamente o que falta para começar
            </h2>
            <p className="text-muted-foreground mb-8 leading-relaxed">
              Após acessar o painel, o checklist de primeiros passos mostra o que falta configurar:
              perfil, serviços, profissionais, horários e revisão do perfil público.
            </p>
            <Button
              asChild
              variant="outline"
            ...
            >
              <Link to="/admin/onboarding">
                Ver primeiros passos <ArrowRight className="ml-2 h-4 w-4" />
              </Link>
            </Button>
          </div>
        </section>
          ...
          <div className="max-w-2xl space-y-8">
            ...
            <div className="pt-4">
              <Button
                asChild
                size="lg"
                className="h-14 px-10 bg-accent text-accent-foreground hover:bg-foreground hover:text-background text-sm font-bold uppercase tracking-wider transition-all"
              >
