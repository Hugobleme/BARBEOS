...
function ConfigPage() {
  ...
  const handleSave = (e: React.FormEvent) => {
    e.preventDefault();
    if (!formData.name.trim()) return toast.error("O nome da barbearia Ã© obrigatÃ³rio.");
    
    // Normalize slug safely
    const normalizedSlug = formData.slug.toLowerCase().trim().replace(/[^a-z0-9-]/g, '-').replace(/-+/g, '-').replace(/^-|-$/g, '');
    if (!normalizedSlug) return toast.error("O link (slug) Ã© invÃ¡lido.");
      ...
      <ScrollArea className="flex-1 px-4 sm:px-6 lg:px-8 py-8">
        <div className="max-w-3xl mx-auto space-y-8 pb-12">
          ...
          <header className="space-y-1">
            <p className="text-[10px] font-bold uppercase tracking-widest text-accent">CONFIGURAÃ‡Ã•ES DA UNIDADE</p>
            <h1 className="text-2xl md:text-3xl font-serif font-bold text-foreground">Perfil da barbearia</h1>
            <p className="text-sm text-muted-foreground">Mantenha as informaÃ§Ãµes da sua unidade atualizadas para uma presenÃ§a pÃºblica mais clara.</p>
          </header>

          {/* PRESENÃ‡A PÃšBLICA STATUS */}
          <section className="space-y-4">
            <h2 className="text-sm font-bold uppercase tracking-wider text-muted-foreground">PresenÃ§a pÃºblica</h2>
            ...
            <form onSubmit={handleSave} className="space-y-8">
              ...
              <section className="space-y-4">
                ...
                <Card className="p-4 sm:p-6 bg-card border-border/40 shadow-sm space-y-6">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="slug-input">EndereÃ§o do perfil (Slug) <span className="text-destructive">*</span></Label>
                    ...
                    <p className="text-[11px] text-muted-foreground">Apenas letras, nÃºmeros e hifens. Ex: barbearia-do-ze</p>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 sm:items-center">
                      ...
                      <div className="flex-1 space-y-1">
                        ...
                        <p className="text-[11px] text-muted-foreground">Insira o link direto de uma imagem pÃºblica para usar como logo.</p>
                      </div>
                    </div>
                  </div>
              ...
              {/* 2. LOCALIZAÃ‡ÃƒO E CONTATO */}
              <section className="space-y-4">
                <h2 className="text-sm font-bold uppercase tracking-wider text-muted-foreground flex items-center gap-2">
                  <MapPin className="h-4 w-4" /> LocalizaÃ§Ã£o e contato
                </h2>
                <Card className="p-4 sm:p-6 bg-card border-border/40 shadow-sm space-y-6">
                  
                  <div className="space-y-4">
                    <h3 className="text-xs font-bold uppercase tracking-wider text-foreground mb-2">EndereÃ§o</h3>
                    <div className="space-y-2">
              ...
              <Card className="p-4 sm:p-6 bg-muted/10 border-border/40 shadow-sm space-y-4">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center gap-3 text-sm">
                    ...
                    <span className={formData.address || formData.city ? "text-foreground" : "text-muted-foreground"}>EndereÃ§o ou localizaÃ§Ã£o</span>
                  </div>
                  <div className="flex items-center gap-3 text-sm">
                  ...
                  <div className="flex items-center gap-3 text-sm">
                    ...
                    <span className={barbershop.description ? "text-foreground" : "text-muted-foreground"}>DescriÃ§Ã£o</span>
                  </div>
                </div>
