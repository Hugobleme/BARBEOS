...
const badgeVariants = cva(
  "inline-flex items-center rounded-full border px-3 py-0.5 text-xs font-medium tracking-wide transition-colors focus:outline-none focus:ring-2 focus:ring-accent focus:ring-offset-2",
  {
    variants: {
      variant: {
        default:
          "border-transparent bg-primary text-primary-foreground shadow-sm hover:bg-white hover:text-black",
        secondary:
        ...
        premium:
          "border-accent/20 bg-accent/10 text-accent hover:bg-accent/20 uppercase tracking-widest text-[10px]",
      },
    },
    defaultVariants: {
      variant: "default",
