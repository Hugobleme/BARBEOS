...
import { h as useCurrentShop, B as Button, L as Label, I as Input, C as Card, i as Skeleton, b as brl, q as TableSkeleton } from "./router-CQpyXUQj.mjs";
import { r as reportService } from "./report.service-Yb7NQv97.mjs";
...
const RevenueChart = reactExports.lazy(() => import("./ReportCharts-CSrUFPU2.mjs").then((m) => ({
  default: m.RevenueChart
})));
const ServicesChart = reactExports.lazy(() => import("./ReportCharts-CSrUFPU2.mjs").then((m) => ({
